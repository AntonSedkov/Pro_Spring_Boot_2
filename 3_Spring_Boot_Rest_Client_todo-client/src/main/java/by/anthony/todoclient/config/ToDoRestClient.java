package by.anthony.todoclient.config;

import by.anthony.todoclient.domain.ToDo;
import by.anthony.todoclient.error.ToDoErrorHandler;
...
public class ToDoRestClient {
    ...
    public ToDo setCompleted(String id) throws URISyntaxException {
        ...
        restTemplate.postForObject(properties.getUrl() +
                properties.getBasePath() + "/{id}?_method=patch", null, ResponseEntity.class, params);
        return findById(id);
    }
